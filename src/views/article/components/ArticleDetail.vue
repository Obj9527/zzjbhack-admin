  ...
  <div class="createPost-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        <el-row>
          <Warning class="warning-border warning"/>
...
<script>
  ...
  const defaultForm = {
    ...
    title: '', // 文章题目
    author: '',
    publishedDate: undefined, // 文章发布时间
    summary: '', // 文章摘要
    content: '', // 文章内容
    source_uri: '', // 文章外链
    image_uri: '', // 文章图片
    createdDate: undefined, //创建时间
    updatedDate: undefined,
    uid: undefined,
    status: 'draft',
    platforms: ['weibo', 'github', 'reddit'],
  ...
  export default {
    ...
    computed: {
      ...
      displayTime: {
        ...
        get() {
          return (+new Date(this.postForm.publishedDate))
        },
        set(val) {
          this.postForm.publishedDate = new Date(val)
        }
      }
    },
    created() {
    ...
    methods: {
      ...
      submitForm() {
        ...
        this.$refs.postForm.validate(valid => {
          if (valid) {
            this.loading = true
            createArticle(this.$refs.postForm)
            this.$notify({
              title: '成功',
              message: '发布文章成功',
              type: 'success',
